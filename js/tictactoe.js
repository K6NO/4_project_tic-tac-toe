var ticTacToeModule = (function() {
    ...
    /**
     * Function to reset game status, used by new game button event handler
     */
    ...
    /**
     * Event handler for play against computer checkbox
     */
    ...
    /**
     * event handlers for board boxes (mouseover, mouseout and click)
     */
    for (var i = 0; i < boxes.length; i++) {
        (function (boxIndex) {
            ...
            boxes[i].addEventListener(('click'), function () {
                ...
                //click event handler - check if state is not terminal and if box is empty
    ...
    /**
     * Function checking if terminal state is reached (X/O won or tie). Returns true if terminal state is reached, false if not.
     * @param theBoard
     * @returns {boolean}
     */
    ...
    /**
     * Function updating the UI if terminal state is reached (uses the gameState global variable)
     * @param isTerminal
     */
    ...
    /**
     * helper function returning an array of empty boxes of the board
     */
    ...
    /**
     * function making a move for the computer - works with random move (commented), works with minimax, but does not reach optimal result
     */
